...
router.route("/upload-resume").put(upload.fields({name: "resume", maxCount: 1}), verifyUserWithRole(["student"]), uploadResume);
...
router.route("/upload-avatar").put(upload.fields({name: "avatar", maxCount: 1}), verifyUserWithRole(["student"]), uploadAvatar);
